...
use DateTime;
use Infra\Integration\AnimeApi\DTOs\TrailerImagesData;
use Infra\Integration\AnimeApi\DTOs\TrailersData;
use Infra\Integration\AnimeApi\DTOs\TitlesData;
use Infra\Integration\AnimeApi\DTOs\MalData;
use Infra\Integration\AnimeApi\DTOs\ImagesData;
use Infra\Integration\AnimeApi\DTOs\BroadcastsData;
    ...
    public static function fromArray(array $data): array
    {
        return [
            ...
            'titles' => TitlesCollection::fromArray(
                array_map(fn ($title) => TitlesData::fromArray([
                    'type'=> $title['type'],
                    'title'=> $title['title'],
                ]), $data['titles'])
            ),
            'images' => AnimeImagesData::fromArray([
                'jpg' => ImagesData::fromArray([
                    'image_url'=> $data['images']['jpg']['image_url'],
                    'small_image_url'=> $data['images']['jpg']['small_image_url'],
                    'large_image_url'=> $data['images']['jpg']['large_image_url'],
                ]),
                'webp' => ImagesData::fromArray([
                    'image_url'=> $data['images']['jpg']['image_url'],
                    'small_image_url'=> $data['images']['jpg']['small_image_url'],
                    'large_image_url'=> $data['images']['jpg']['large_image_url'],
                ]),
