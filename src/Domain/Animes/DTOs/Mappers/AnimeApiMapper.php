    ...
    public static function fromArray(array $data): array
    {
        return [
            ...
            'titles' => TitlesCollection::fromArray(
                array_map(fn (array $title): TitleData => TitleData::fromArray([
                    'type' => $title['type'],
                    'title' => $title['title'],
                ]), $data['titles'])
            ),
            'broadcast' => !empty($data['broadcast']) ? BroadcastData::fromArray([
            ...
            'genres' => GenresCollection::fromArray(
                array_merge(
                    ! empty($data['genres'])
                        ? array_map(fn (array $genre): GenreData => GenreData::fromArray([
                            'mal_id' => $genre['mal_id'],
                            'mal_url' => $genre['url'],
                            'name' => $genre['name'],
